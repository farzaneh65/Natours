    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.assign('/', true); // set tru to reload from the server not caching from the browser
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFyemFuZWg2NSIsImEiOiJja2F3N2w0OGExOGgwMnlwdDl5dGlncW0wIn0.yVCkN06vyBW3Z-Dwy84Lag';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/farzaneh65/ckaw8dhab39kk1ipdt75wucvw',
    scrollZoom: false //   center: [-118.133686, 34.106055],
    //   zoom: 10,
    //   interactive: false
...
var userPassowrdForm = document.querySelector('.form-user-password'); /// Delegation
